...
function tema_js_css_init()
{
    ...
    // Scripts Javascript
    wp_register_script('commonJs', get_template_directory_uri() . '/assets/dist/js/theme-wp-globals.js', array('jquery'), '27.0', true);
    wp_register_script('homeJs', get_template_directory_uri() . '/assets/dist/js/theme-wp-home.js');
    wp_register_script('categoryJs', get_template_directory_uri() . '/assets/dist/js/theme-wp-category.js');
    wp_register_script('searchJs', get_template_directory_uri() . '/assets/dist/js/theme-wp-search.js');
    ...
    // Scripts CSS
    wp_register_style('commonCss', get_template_directory_uri() . '/assets/dist/css/theme-wp-globals.css'); 
    wp_register_style('homeCss', get_template_directory_uri() . '/assets/dist/css/theme-wp-home.css');
    wp_register_style('categoryCss', get_template_directory_uri() . '/assets/dist/css/theme-wp-category.css');
    wp_register_style('searchCss', get_template_directory_uri() . '/assets/dist/css/theme-wp-search.css');
